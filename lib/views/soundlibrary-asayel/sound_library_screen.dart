...
class SoundLibraryScreen extends StatefulWidget {
  final SoundLibraryService service;
  const SoundLibraryScreen({Key? key, required this.service}) : super(key: key);
            ...
            child: SingleChildScrollView(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildSoundCard(sound['index'], sound['title'],
                      sound['sub'], sound['img']);
                },
              ),
            ),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Transform.scale(
                scale: 0.7,
                child: Switch(
                  value: widget.service.isEnabled(title),
                  onChanged: (val) =>
                      setState(() => widget.service.setEnabled(title, val)),
                  activeThumbColor: const Color(0xFF43416D),
                ),
              ),
            ],
          ),
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                icon:
                    const Icon(Icons.arrow_drop_down, color: Color(0xFF1D1B3F)),
                items: ['Vibration Pattern']
          ...
          SliderTheme(
            data: SliderThemeData(
              ...
              overlayColor: const Color(0xFF1D1B3F).withValues(alpha: 0.1),
            ),
            child: Slider(
